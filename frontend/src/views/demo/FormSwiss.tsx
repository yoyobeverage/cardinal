// Swiss / Brutalist variant. White background, pure black type, single neon
// accent. Massive display type, heavy 2px black borders, asymmetric grid.
// Inspired by Müller-Brockmann + early Robinhood + Hyperliquid landing.
...
const INK_3 = "#737373";
const RULE = "#0a0a0a";
const RULE_LIGHT = "#e5e5e5";
const ACCENT = "#ff4d00"; // burnt-orange / sienna
const ACCENT_BG = "#fff1ea";

export default function FormSwiss() {
  ...
  return (
    <div className="min-h-screen" style={{ background: BG, color: INK, fontFamily: SANS }}>
      ...
      <main className="mx-auto max-w-6xl px-8 py-16">
        ...
        >
          <div className="col-span-12 lg:col-span-7">
            ...
            >
              ...
              ways to earn
              <br />
              <span style={{ fontFamily: DISPLAY, fontStyle: "italic", fontWeight: 400 }}>
                yield.
              </span>
            </h1>
          </div>
        ...
        {/* Form: oversized number labels left, fields right */}
            ...
            {[
              ...
              >
                ...
                <div
                  ...
                  style={{
                    color: wrapper === val ? "rgba(255,255,255,0.6)" : INK_3,
                  }}
                >
                  {hint}
                </div>
        ...
        <NumberedSection num="04" label="Anything else?">
          <textarea
            ...
            className="w-full resize-none border-b-2 bg-transparent py-3 text-xl outline-none transition focus:border-current"
            style={{ color: INK, borderColor: RULE_LIGHT, fontFamily: SANS }}
          />
        ...
        {/* CTA block */}
        <div
          className="mt-8 border-t-[3px] pt-8"
          style={{ borderColor: RULE }}
        >
          <div className="flex flex-wrap items-end justify-between gap-6">
            ...
            <button
              ...
              className="group relative overflow-hidden px-10 py-5 text-base font-bold uppercase tracking-[0.15em] transition"
              style={{
                background: INK,
                color: BG,
                fontFamily: SANS,
        ...
        >
          ...
          <span style={{ color: ACCENT }}>Swiss preview</span>
          <span>Qdrant Hackathon</span>
        </footer>
      </main>

      {/* Floating accent block - very Swiss */}
      <div
        className="fixed bottom-0 right-0 z-0 h-3 w-3"
